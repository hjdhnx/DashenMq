...
#  Jun 22, 2019 08:29:38 PM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 600x433+584+148
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
将在程序结束后自动删除，不可保存}
    ...
    place $site_4_4.lab44 \
        ...
        -relheight 0 -anchor nw -bordermode ignore 
    frame $top.tNo48.t5 \
        -background {#496fd8} -highlightbackground {#d9d9d9} \
        -highlightcolor black 
    vTcl:DefineAlias "$top.tNo48.t5" "TNotebook1_t5" vTcl:WidgetProc "Toplevel1" 1
    $top.tNo48 add $top.tNo48.t5 \
        -padding 0 -sticky nsew -state normal -text 语音通话 -image {} \
        -compound none -underline -1 
    set site_4_5  $top.tNo48.t5
    button $site_4_5.but43 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#78C300} -command btn_phone \
        -disabledforeground {#a3a3a3} -font TkDefaultFont \
        -foreground {#ffffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text 开启通话 
    vTcl:DefineAlias "$site_4_5.but43" "Button_phone" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox $site_4_5.tCo44 \
        -values {{"小燕子"} {"达神"}} -font TkTextFont -textvariable varperson \
        -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$site_4_5.tCo44" "TCombobox_person" vTcl:WidgetProc "Toplevel1" 1
    ttk::label $site_4_5.tLa46 \
        -background {#78C300} -foreground {#ffffff} -font TkDefaultFont \
        -relief flat -text 通话对象 
    vTcl:DefineAlias "$site_4_5.tLa46" "TLabel29" vTcl:WidgetProc "Toplevel1" 1
    ttk::label $site_4_5.tLa47 \
        -background {#78C300} -foreground {#ffffff} -font TkDefaultFont \
        -relief flat -text 延迟时间 
    vTcl:DefineAlias "$site_4_5.tLa47" "TLabel30" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox $site_4_5.tCo48 \
        -values {300 1000 2000} -font TkTextFont -textvariable vardelay \
        -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$site_4_5.tCo48" "TCombobox_delay" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_5.but44 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#78C300} -command btn_listen \
        -disabledforeground {#a3a3a3} -font TkDefaultFont \
        -foreground {#ffffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text 试听 
    vTcl:DefineAlias "$site_4_5.but44" "Button_listen" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_5.but45 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#78C300} -command btn_sendluyin \
        -disabledforeground {#a3a3a3} -font TkDefaultFont \
        -foreground {#ffffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text 发送 
    vTcl:DefineAlias "$site_4_5.but45" "Button_senluyin" vTcl:WidgetProc "Toplevel1" 1
    button $site_4_5.but46 \
        -activebackground {#ececec} -activeforeground {#000000} \
        -background {#78C300} -command btn_luyin \
        -disabledforeground {#a3a3a3} -font TkDefaultFont \
        -foreground {#ffffff} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text 开启录音 
    vTcl:DefineAlias "$site_4_5.but46" "Button_luyin" vTcl:WidgetProc "Toplevel1" 1
    spinbox $site_4_5.spi46 \
        -activebackground {#f9f9f9} -background white \
        -buttonbackground {#d9d9d9} -disabledforeground {#a3a3a3} -font font9 \
        -foreground black -from 1.0 -highlightbackground black \
        -highlightcolor black -increment 1.0 -insertbackground black \
        -selectbackground {#c4c4c4} -selectforeground black \
        -textvariable spinbox_luyintime -to 100.0 -values {1 2 3 4} 
    vTcl:DefineAlias "$site_4_5.spi46" "Spinbox1" vTcl:WidgetProc "Toplevel1" 1
    ttk::label $site_4_5.tLa48 \
        -background {#78C300} -foreground {#ffffff} -font TkDefaultFont \
        -relief flat -text 秒数 
    vTcl:DefineAlias "$site_4_5.tLa48" "TLabel31" vTcl:WidgetProc "Toplevel1" 1
    place $site_4_5.but43 \
        -in $site_4_5 -x 10 -y 140 -width 229 -relwidth 0 -height 28 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_5.tCo44 \
        -in $site_4_5 -x 70 -y 40 -anchor nw -bordermode ignore 
    place $site_4_5.tLa46 \
        -in $site_4_5 -x 10 -y 40 -anchor nw -bordermode ignore 
    place $site_4_5.tLa47 \
        -in $site_4_5 -x 10 -y 90 -anchor nw -bordermode ignore 
    place $site_4_5.tCo48 \
        -in $site_4_5 -x 70 -y 90 -anchor nw -bordermode ignore 
    place $site_4_5.but44 \
        -in $site_4_5 -x 370 -y 90 -width 145 -relwidth 0 -height 28 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_5.but45 \
        -in $site_4_5 -x 370 -y 140 -width 149 -relwidth 0 -height 28 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_5.but46 \
        -in $site_4_5 -x 370 -y 40 -width 139 -relwidth 0 -height 28 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_5.spi46 \
        -in $site_4_5 -x 310 -y 40 -width 55 -relwidth 0 -height 21 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_5.tLa48 \
        -in $site_4_5 -x 270 -y 40 -anchor nw -bordermode ignore 
    button $top.but43 \
        -activebackground {#ececec} -activeforeground {#000000} \
